 ...
 * @author Asus
 */
public class newResidentTenant extends javax.swing.JFrame {

    /**
     * Creates new form newResidentTenant
     */
    public newResidentTenant() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(newResidentTenant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new newResidentTenant().setVisible(true);
            }
        });
    }
