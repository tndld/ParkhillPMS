 ...
 * @author hoong
 */
public class EditAssignedJob extends javax.swing.JFrame {
    String fileLoc = "database\\assignedTask.txt";
    Object[] rowData;
    int id;
    /**
     * Creates new form EditAssignedJob
     */
    public EditAssignedJob(Object[] rowData) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Assigned Task");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(duedateTF, javax.swing.GroupLayout.PREFERRED_SIZE, 327, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(231, 231, 231)
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        // TODO add your handling code here:
        if (descriptionTF.getText().isEmpty() || workerTF.getText().isEmpty() || statusTF.getText().isEmpty() || duedateTF.getText().isEmpty()) {
        ...
        rowData[2] = workerName;
        rowData[3] = status;
        rowData[4] = completeBy;
        if (task.updateTask(id, description, workerName, status, completeBy, fileLoc)){
            JOptionPane.showMessageDialog(this, "Task has been successfully updated");
            new ViewSpecificAssignedJob(rowData).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAssignedJob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditAssignedJob(null).setVisible(true);
            }
        });
    }
