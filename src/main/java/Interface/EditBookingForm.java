 ...
 * @author hoong
 */
public class EditBookingForm extends javax.swing.JFrame {
    String typeOfFac;
    int id;
    Object[] rowData;
    /**
     * Creates new form EditBookingform
     * @param rowData
     * @param typeOfFacility
     */
    public EditBookingForm(Object[] rowData, String typeOfFacility) {
        initComponents();
        Toolkit toolkit = getToolkit();
        Dimension size = toolkit.getScreenSize();
        setLocation(size.width / 2 - getWidth() / 2, size.height / 2 - getHeight() / 2);
        typeOfFac = typeOfFacility.toLowerCase();
        ...
        nameTF.setText(rowData[1].toString());
        numTF.setText(rowData[2].toString());
        unitTF.setText(rowData[3].toString());
        
        
        SimpleDateFormat inputDateFormat = new SimpleDateFormat("dd MMM yyyy");
        try {
            Date date = inputDateFormat.parse(rowData[4].toString());
            dateTF.setDate(date);
        } catch (ParseException ex) {
            Logger.getLogger(EditBookingForm.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        int selectedIndex = -1;
        for (int i = 0; i < timeDropdown.getItemCount(); i++) {
            if (timeDropdown.getItemAt(i).equals(rowData[5].toString())) {
                selectedIndex = i;
            break;
            }
        }
        ...
        if (selectedIndex >= 0) {
            timeDropdown.setSelectedIndex(selectedIndex);
        }
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        if (book.editBooking(id, name, contact, unitNum, date, time, fileLoc)){
            JOptionPane.showMessageDialog(this, "Booking has been updated!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditBookingForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditBookingForm(null, null).setVisible(true);
            }
        });
    }
